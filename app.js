...
app.post('/email', function(req, res) {
    ...
    if(recipients){
        var html = 'Hello,<br><br>My name is Zack Boman. I appreciate your sincere consideration \
            ...
            <ul><li><strong>Computing Languages:</strong> JavaScript, HTML5, CSS3, Java, Python, C# and SQL</li>\
            <li><strong>Server Side:</strong> Node.js, MongoDB and ASP.NET</li>\
            <li><strong>Web Design:</strong> Layout, User Interface and User Experience</li></ul><br>\
            ...
            Sincerely,<br><strong>Zack Boman</strong><br>Software Developer<br>Code Enthusiast<br>';
        var plaintext = 'Hello, \n\nMy name is Zack Boman. I appreciate your sincere consideration \
            ...
            You can contact me anytime, day or night, on my cell at (801) 589-0692 or at my email at \
            zack.boman@gmail.com.  I have attached a copy of my resum&eacute; and references. You can also find out a lot more about me and even view \
